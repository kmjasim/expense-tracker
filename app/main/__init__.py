...
from . import index, debt, payments, transfers, categories, accounts, recipients, finance_score_routes, transactions, transactions_actions,routes_recurring, routes_budget # noqa: E402,F401
